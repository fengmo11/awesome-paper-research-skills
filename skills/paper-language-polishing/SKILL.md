...
description: Use when polishing academic manuscript language, especially Chinese-to-English scientific writing, Nature-style or venue-aware prose, section-aware tense, hedging, overclaim control, AI-voice cleanup, article repair, and claim-preserving revision.
---
...
8. Remove AI-looking punctuation, adverb overuse, generic transitions, and inflated wording.
9. Return polished text plus a brief change log.
...
- Quotation marks, em dashes, parentheses, and adverbs are not overused.
- Generic AI-like phrases are replaced with evidence-specific scientific prose.
